        ...
        <div class="container">
            ...
            @else
                <div class="card card-body shadow text-center p-md-5">
                    <h4>No items added to the cart to checkout</h4>
                    <a href="{{url('collections')}}" class="btn btn-info text-white">Shop now</a>
                </div>
            @endif
        </div>
    </div>
...
@push('scripts')
<script src="https://www.paypal.com/sdk/js?client-id=AS1j2ufztLYp0_DJBIjXw1ojLS_OHE6cwIwNHqX4orFYTfMCpsDEJ0-0pb4483w-VgcU1mZsMHJNNc3n&currency=USD"></script>
...
<script>
  paypal.Buttons({
    ...
    createOrder: (data, actions) => {
      return actions.order.create("/my-server/create-paypal-order", {
        method: "POST",
        headers: {
