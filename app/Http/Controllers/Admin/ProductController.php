...
class ProductController extends Controller
{
    ...
    public function destroyImage(int $product_image_id)
    {
        ...
        $productImage->delete();
        return redirect()->back()->with('message','Product Image Deleted Successful');
    }
    ...
    public function updateProdColQty(Request $request, $product_color_id)
    {
    ...
    public function deleteProdColQty($product_color_id)
    {
        $prodClr=ProductColor::findOrFail($product_color_id);
        $prodClr->delete();
